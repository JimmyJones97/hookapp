...
public class HomeActivity extends VActivity implements HomeContract.HomeView {
    ...
    private void initMenu() {
        ...
        menu.add("hookLocation").setIcon(R.drawable.ic_notification).setOnMenuItemClickListener(item -> {
            startActivity(new Intent(this, io.virtualapp.home.location.MainActivity.class));
            return true;
        });
        ...
        menu.add("About").setIcon(R.drawable.ic_settings).setOnMenuItemClickListener(item -> {
            Toast.makeText(this, "CopyRight QQ:195471129", Toast.LENGTH_SHORT).show();
            return false;
        });
